...
% LaTeX Template
% with National ChengChi University logo
% Version 1.0 (10/7/19)
%
% Based on:
...
\Large \textbf{Tsai Jie Li}\\[0.5cm] % Author(s)
\Large College of Science\\[0.4cm]   % University/organization
...
Wenshan District, Taipei.\\[1cm]
Phone: +886 (02)2939-3091 \#68006\\ % Phone number
Email: \texttt{emrlab@nccu.edu.tw}% Email address
\end{minipage}
